...
const items = [
  { title: 'HAIR CARE', items: ['Relaxer & Color Treatments', 'Shampoo & Conditioners', 'Styling', 'Hair Treatments', 'Other Hair Care'] },
  { title: 'BODY CARE', items: ['Cream, Gel & Lotions', 'Shower & Soap', 'Serum Glucerin & Oils', 'Makeup', 'Other Body Care'] },
  { title: 'CHILDREN CARE', items: ['Hair Care', 'Body Care', 'Others Children Care',] },
  { title: 'MEN CARE', items: ['Hair Care', 'Body Care', 'Others Men Care',], },
];
