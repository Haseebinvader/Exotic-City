...
const RequestQuote = () => {
  ...
  const groupedCart = cart.reduce((groups, cartItem) => {
    ...
    if (existingGroup) { existingGroup.quantity += 1; } else {
